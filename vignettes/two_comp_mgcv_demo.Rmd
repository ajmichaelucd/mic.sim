...
So the difference between this and the nonlinear trends in pi model is just that I'm using gam instead of survreg, which makes me think I must be doing something wrong with how I'm using gam(), especially in the mu component portion  
